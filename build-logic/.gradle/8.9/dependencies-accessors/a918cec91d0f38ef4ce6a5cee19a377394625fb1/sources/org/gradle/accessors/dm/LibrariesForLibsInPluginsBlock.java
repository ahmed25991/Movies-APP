...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final VideoLibraryAccessors laccForVideoLibraryAccessors = new VideoLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>datepicker</b> with <b>com.github.ozcanalasalvar.picker:datepicker</b> coordinates and
    ...
    /**
     * Dependency provider for <b>firebasemessaging</b> with <b>com.google.firebase:firebase-messaging</b> coordinates and
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getFirebasemessaging() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("firebasemessaging");
    }

    /**
     * Dependency provider for <b>googleMaps</b> with <b>com.google.android.gms:play-services-maps</b> coordinates and
     * with version reference <b>googlemapsversion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getGoogleMaps() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("googleMaps");
    }
     ...
     * with version reference <b>guavaversion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Dependency provider for <b>intercomfcm</b> with <b>io.intercom.android:intercom-sdk-fcm</b> coordinates and
     * with version reference <b>intercom</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getIntercomfcm() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("intercomfcm");
    }

    /**
     * Dependency provider for <b>intercomsdk</b> with <b>io.intercom.android:intercom-sdk</b> coordinates and
     * with version reference <b>intercom</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getIntercomsdk() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("intercomsdk");
    }
    ...
    /**
     * Dependency provider for <b>localizationManager</b> with <b>com.github.emirhanemmez:localizationmanager</b> coordinates and
     * with version reference <b>localizationManager</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getLocalizationManager() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("localizationManager");
    }

    /**
     * Dependency provider for <b>locationUpdates</b> with <b>com.google.android.gms:play-services-location</b> coordinates and
     * with version reference <b>locationupdatesversion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getLocationUpdates() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("locationUpdates");
    }
     ...
     * with version reference <b>permissionsversion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Dependency provider for <b>placesMaps</b> with <b>com.google.android.libraries.places:places</b> coordinates and
     * with version reference <b>placesMapVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getPlacesMaps() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("placesMaps");
    }

    /**
     * Dependency provider for <b>sdplib</b> with <b>com.github.Kaaveh:sdp-compose</b> coordinates and
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getSdplib() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("sdplib");
    }

    /**
     * Dependency provider for <b>sharedpref</b> with <b>androidx.security:security-crypto</b> coordinates and
     * with version reference <b>sharedpref</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getSharedpref() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("sharedpref");
    }

    /**
     * Dependency provider for <b>systemControlUi</b> with <b>com.google.accompanist:accompanist-systemuicontroller</b> coordinates and
     * with version reference <b>systemControlUi</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getSystemControlUi() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("systemControlUi");
    }
    ...
    /**
     * Group of libraries at <b>video</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public VideoLibraryAccessors getVideo() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForVideoLibraryAccessors;
    }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>constraint</b> with <b>androidx.constraintlayout:constraintlayout-compose</b> coordinates and
         * with version reference <b>compose.constraint</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getConstraint() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("compose.constraint");
        }
    ...
    public static class JavaxLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>inject</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>kotlinxSerialization</b> with <b>io.ktor:ktor-serialization-kotlinx-json</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getKotlinxSerialization() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("ktor.kotlinxSerialization");
        }
    ...
    public static class MediaLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>video.player</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class MoshiLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>moshi.kotlin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class NavigationLibraryAccessors extends SubDependencyFactory {
        private final NavigationCommonLibraryAccessors laccForNavigationCommonLibraryAccessors = new NavigationCommonLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>navigation.common</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public NavigationCommonLibraryAccessors getCommon() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForNavigationCommonLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class NavigationCommonLibraryAccessors extends SubDependencyFactory {

        public NavigationCommonLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getKtx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("navigation.common.ktx");
        }
     ...
     */
    @Deprecated
    public static class VideoLibraryAccessors extends SubDependencyFactory {

        public VideoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final VideoVersionAccessors vaccForVideoVersionAccessors = new VideoVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>androidDesugarJdkLibs</b> with value <b>2.1.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>datepicker</b> with value <b>2.0.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googlemapsversion</b> with value <b>19.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGooglemapsversion() { return getVersion("googlemapsversion"); }
        ...
        /**
         * Version alias <b>guavaversion</b> with value <b>33.0.0-jre</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>inject</b> with value <b>1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>intercom</b> with value <b>15.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIntercom() { return getVersion("intercom"); }
        ...
        /**
         * Version alias <b>ktor</b> with value <b>2.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>localizationManager</b> with value <b>1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLocalizationManager() { return getVersion("localizationManager"); }

        /**
         * Version alias <b>locationupdatesversion</b> with value <b>21.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLocationupdatesversion() { return getVersion("locationupdatesversion"); }
        ...
        /**
         * Version alias <b>permissionsversion</b> with value <b>0.35.0-alpha</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPermissionsversion() { return getVersion("permissionsversion"); }

        /**
         * Version alias <b>placesMapVersion</b> with value <b>4.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlacesMapVersion() { return getVersion("placesMapVersion"); }
        ...
        /**
         * Version alias <b>sharedpref</b> with value <b>1.1.0-alpha06</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSharedpref() { return getVersion("sharedpref"); }

        /**
         * Version alias <b>systemControlUi</b> with value <b>0.34.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSystemControlUi() { return getVersion("systemControlUi"); }
        ...
        /**
         * Version alias <b>versionCode</b> with value <b>1600</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>versionName</b> with value <b>6.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.video</b>
         */
        public VideoVersionAccessors getVideo() {
            return vaccForVideoVersionAccessors;
        }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>compose.constraint</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getConstraint() { return getVersion("compose.constraint"); }
    ...
    public static class CoroutinesVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>coroutines.test</b> with value <b>1.8.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        private final GoogleCodeVersionAccessors vaccForGoogleCodeVersionAccessors = new GoogleCodeVersionAccessors(providers, config);
        public GoogleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.google.code</b>
         */
        public GoogleCodeVersionAccessors getCode() {
            return vaccForGoogleCodeVersionAccessors;
        }

    }

    public static class GoogleCodeVersionAccessors extends VersionFactory  {

        public GoogleCodeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>google.code.gson</b> with value <b>2.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGson() { return getVersion("google.code.gson"); }
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Group of versions at <b>versions.kotlin.compiler</b>
         */
    ...
    public static class KotlinCompilerVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlin.compiler.extension</b> with value <b>1.5.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MoshiVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>moshi.kotlin</b> with value <b>1.15.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class VideoVersionAccessors extends VersionFactory  {

        public VideoVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>video.player</b> with value <b>1.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayer() { return getVersion("video.player"); }
